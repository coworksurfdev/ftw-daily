...
export default function checkoutPageReducer(state = initialState, action = {}) {
  ...
  switch (type) {
    ...
    case ACCEPT_SALE_REQUEST:
      return {
        ...state, acceptInProgress: true, acceptSaleError: null, declineSaleError: null
      }
    ...
    case DECLINE_SALE_REQUEST:
      return {
        ...state, declineInProgress: true, declineSaleError: null, acceptSaleError: null
      }
  ...
  .then((timeSlots) => {
    ...
    if (secondRequest) {
      ...
      return dispatch(timeSlotsRequest(secondParams)).then((secondBatch) => {
        console.log(secondBatch, 'transaction page second batch')
        const combined = timeSlots.concat(secondBatch)
        console.log(secondBatch, 'transaction page combined')
